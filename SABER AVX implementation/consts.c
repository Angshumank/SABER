...
//uint32_t _q8x[16] asm ("_q8x") = {KYBER_Q, KYBER_Q, KYBER_Q, KYBER_Q, KYBER_Q, KYBER_Q, KYBER_Q, KYBER_Q};
//uint32_t _q8x[16] asm ("_q8x") = {LWR_Q, LWR_Q, LWR_Q, LWR_Q, LWR_Q, LWR_Q, LWR_Q, LWR_Q};
uint32_t _q8x[16] asm ("_q8x") = {0, 0, 0, 0, 0, 0, 0, 0};
