...
int test_kem_cca()
{
  ...
  uint8_t pk[LWR_PUBLICKEYBYTES];
  uint8_t sk[LWR_SECRETKEYBYTES];
  uint8_t c[LWR_BYTES_CCA_DEC];	
  uint8_t k_a[LWR_KEYBYTES], k_b[LWR_KEYBYTES];
