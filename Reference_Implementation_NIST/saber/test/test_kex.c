...
{
	//test_kem_cca();
	printf("SABER_SECRETKEYBYTES : %lu\n",SABER_SECRETKEYBYTES);
	printf("SABER_INDCPA_SECRETKEYBYTES : %lu\n",SABER_INDCPA_SECRETKEYBYTES);
	printf("SABER_INDCPA_PUBLICKEYBYTES : %lu\n",SABER_INDCPA_PUBLICKEYBYTES);
	printf("SABER_HASHBYTES : %lu\n",SABER_HASHBYTES);
	printf("SABER_KEYBYTES : %lu\n",SABER_KEYBYTES);
	return 0;
}
